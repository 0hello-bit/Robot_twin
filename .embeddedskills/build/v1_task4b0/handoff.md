...
```bash
"C:/Users/24668/AppData/Local/Programs/Python/Python311/python.exe" -m pytest simulation/digital_twin/tests/test_v1_twin_schema.py -v
"C:/Users/24668/AppData/Local/Programs/Python/Python311/python.exe" -m pytest simulation/digital_twin/tests/test_v1_twin_isolation.py -v
# 冲突/回归验证（与遗留 config 导入测试 + Task 3 测试同进程）:
"C:/Users/24668/AppData/Local/Programs/Python/Python311/python.exe" -m pytest simulation/digital_twin/tests/test_v1_twin_schema.py simulation/digital_twin/tests/test_v1_twin_isolation.py simulation/digital_twin/tests/test_config.py simulation/digital_twin/tests/test_sensor.py simulation/digital_twin/tests/test_campaign_metrics.py simulation/digital_twin/tests/test_campaign_store.py simulation/digital_twin/tests/test_runtime_protocol.py
```
